    ...
    <form class="form-add-banner" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form">
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control input-add-banner" id="" placeholder="Banner name" value="{{old('name')}}">
                @error('dish_name')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="description" class="form-control input-add-banner" id="" placeholder="Description" value="{{old('description')}}">
                @error('description')
                    <span style="color: red">{{$message}}</span>
                @enderror
            </div>
